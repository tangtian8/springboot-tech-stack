...
producer.setNamesrvAddr("47.108.167.224:9876");
...
// 2. 设置 NameServer 地址
consumer.setNamesrvAddr("47.108.167.224:9876");
...
4. 即使消费者重启，订阅关系仍然存在
5. 通过命令可以查看：
   sh mqadmin consumerProgress -n 47.108.167.224:9876 -g order_consumer_group
